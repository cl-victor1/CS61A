...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while current_place.is_hive == False:
            if random_bee(current_place.bees) != None and self.upper_bound >= index >= self.lower_bound:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        super(FireAnt, self).reduce_health(amount)
...
class HungryAnt(Ant):
    ...
    name = 'Hungry'
    chewing_turns = 3
    def __init__(self, turns_to_chew=0):
    ...
    def action(self, gamestate):
        ...
        while current_place != None:
            if current_place.ant != None:
                ...
                if current_place.ant.is_container == True and current_place.ant.ant_contained != None:
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while current_place.is_hive == False:
            ...
            for bee in bees_copy:
                res[bee] = distance
            if current_place == self.place:
                if current_place.ant.is_container:
                    res[current_place.ant] = distance
            elif current_place != self.place:
                if current_place.ant != None:
                    res[current_place.ant] = distance
                    if current_place.ant.is_container == True and current_place.ant.ant_contained != None:
                        res[current_place.ant.ant_contained] = distance
            distance += 1
            current_place = current_place.entrance
        return res
        # END Problem Optional 2
