...
def boar_brawl(player_score, opponent_score):
    ...
    return max(3 * abs(player_ones - opponent_tens), 1)
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            numb_rolls = strategy0(score0, score1)
            score0 = update(numb_rolls, score0, score1, dice)
            who = 1 - who
        else:
            numb_rolls = strategy1(score1, score0)
            score1 = update(numb_rolls, score1, score0, dice)
            who = 1 - who
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    benchmark = strategy(0, 0)
    for i in range(goal):
        for j in range(goal):
            if strategy(i, j) != benchmark:
                return False
    return True
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    values = []
    for i in range(1,11):
        values.append(averaged_dice(i, dice))
    max_roll = 1
    for i in range(9):
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if sus_update(0, score, opponent_score) >= sus_update(6, score, opponent_score):
        return 0
    else:
        return 6
    # END PROBLEM 12
